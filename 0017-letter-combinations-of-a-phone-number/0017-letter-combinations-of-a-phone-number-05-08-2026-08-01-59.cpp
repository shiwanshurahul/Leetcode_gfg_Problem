...
void solve(int idx,string &digits, unordered_map<char,string> mp,string &temp){
    ...
    vector<string> letterCombinations(string digits) {
        ...
        mp['9'] ="wxyz";
        string temp ="";
        solve(0,digits,mp,temp); //0-> idx for traversin ovr digits
        return ans;
    }//2 char ke combinat chahiy for digits= '23' = ek string pe iterate and call for another = 'ad', .. 
// e.g.2.  digits= "232"
// Output
...
// solve(2, digits, mp, temp); -> base case = retur
...
// Without loop → you must write 2 (or more) recursiv calls
