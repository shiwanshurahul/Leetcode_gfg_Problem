...
int solve(vector<int> &nums, int i, vector<int> &dp){
  ...
  // When a function returns, execution resumes exactly after the function
  // call line in the same stack frame.
  //simple recursion me v aisa hota
};// solve(0) -> solve(i=1) -> solve(i=2) -> solve(i=3) -> solve(i=4) -> return 0
   //sbka i se initallly call jaega fir sbka j chlega and min aeg