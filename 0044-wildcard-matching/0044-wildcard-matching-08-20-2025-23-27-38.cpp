...
bool solve(string &s, string &p, int i, int j, vector<vector<int>> &dp){
    ...
    if(i>=0 && j<0)  //pattern khatam but string bacha hai -> s="aa", p ='"a"
        return false;
    ...
    bool isMatch(string s, string p) {
        ...
        // '*' -> matches/replaces seq of char/string e.g abc, empty string
    ...
    //e.g. s = a b c d e
    //     p = a * c ? e
    //         *b man liya tmne = can take as your req len of string
};