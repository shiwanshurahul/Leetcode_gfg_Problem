...
int tabulation(vector<vector<int>>& grid){
    ...
    // exactly one element from each row of grid such that no two elements chosen in adjacent rows are in the same column.
    ...
    // That should qpply, unless two minimum elements are in the same 
